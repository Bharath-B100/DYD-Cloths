...
exports.seedSettings = async (req, res) => {
    try {
        const initialSettings = [
            ...
            { key: 'site_name', value: 'DYD-Cloths', label: 'Site Name', category: 'branding', type: 'text' },
            { key: 'site_tagline', value: 'Design your Dream Cloths', label: 'Tagline', category: 'branding', type: 'text' },
            ...
            { key: 'hero_title', value: 'Design Your <span class="text-gradient">Dream</span> Cloths', label: 'Hero Title', category: 'homepage', type: 'text' },
